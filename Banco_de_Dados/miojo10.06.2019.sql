...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Jun-2019 às 05:43
...
INSERT INTO `atendimento` (`ID_ATENDIMENTO`, `TIPO`, `TRATAMENTO`, `DATA_HORA_INTERNACAO`, `DATA_HORA_SAIDA`, `HOSPITAL`, `BOLETIM_ID_BOLETIM`) VALUES
(1, NULL, 'teste', '0000-00-00 00:00:00', NULL, NULL, 1);
...
(2, '1', '', '', 'Sim', NULL, '', '', 3, 0, 0),
(3, '100', '38', '100', 'Sim', NULL, '12.8', 'nenhuma', 3, 0, 0),
(4, '1', '1', '1', 'Sim', NULL, '1', '1', 3, 0, 0),
(5, '100kg', '36c', '100bpm', 'Sim', NULL, '12/1000', 'nenhuma', 3, 0, 0),
(6, '10', '10', '10', 'Sim', NULL, '10', '', 5, 0, 0),
(7, '100', '36º', '100', 'Sim', NULL, 'n sei', 'n sei', 6, 0, 0);
...
CREATE TABLE `exame` (
  ...
  `DESCRICAOe` varchar(45) DEFAULT NULL,
...
INSERT INTO `exame` (`ID_EXAME`, `DESCRICAOe`, `ID_TIPO`) VALUES
...
(15, 'FABRICANTE NACIONAL', '1', 'TESTE', 'MEDICAMENTO TESTE', 'TESTE 2', '09/06/2019', '11/10/1996');
...
--
ALTER TABLE `exame`
  MODIFY `ID_EXAME` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `remedio`
  MODIFY `ID_REMEDIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
