...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Jun-2019 às 00:06
...
(6, NULL, NULL, '0000-00-00 00:00:00', NULL, 0, 10, 0, 0),
(7, NULL, NULL, '0000-00-00 00:00:00', NULL, 0, 2, 0, 0);
...
(10, '61', '40', '120', 'Sim', NULL, '16/6', 'hipertensao', 9, 1, 39);
...
(53, 'Ana Paula', '123.123.123-12', '111111111', 'divorciado', 'f', 0, '01/07/1997'),
(54, 'Douglas Garcia', '86846558005', '123123123', 'solteiro', 'm', 0, '2000-01-01'),
(55, 'Rafael', '321.321.321-32', '321321312', 'separado', 'm', 0, '11/11/1990');
...
--
ALTER TABLE `atendimento`
  MODIFY `ID_ATENDIMENTO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `pessoa`
  MODIFY `ID_PESSOA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `responsavel`
  MODIFY `ID_RESPONSAVEL` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
