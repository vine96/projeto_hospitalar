...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Jun-2019 às 00:47
...
(8, NULL, NULL, '0000-00-00 00:00:00', NULL, 0, 11, 1, 0),
(9, NULL, NULL, '0000-00-00 00:00:00', NULL, 0, 14, 0, 0),
(10, NULL, NULL, '0000-00-00 00:00:00', NULL, 0, 13, 0, 1);
...
(11, '55', '38', '120', 'Sim', NULL, '70', '', 10, 2, 39),
(12, '87', '36', '150', 'Sim', NULL, '80', '', 11, 3, NULL),
(13, '78', '36', '110', 'Sim', NULL, '90', '', 12, 2, 39),
(14, '87', '36', '120', 'Sim', NULL, '70', '', 10, 1, 39);
...
(41, 'Farmacêutico', '654.646.465-47', '546546546545', 'solteiro', 'm', 0, ''),
(56, 'Alana Frutuoso de Mello', '850.168.290-05', '6108291245', 'solteiro', 'f', 0, '01/11/1993'),
(57, 'Douglas Garcia', '85016829006', '51487859542', 'solteiro', 'm', 0, '2005-07-01'),
(58, 'Andréia Mattos', '15423615498', '12459763521', 'solteiro', 'f', 0, '1964-12-12'),
(59, 'Ricardo Bartolomeu', '784.541.132-54', '1245678921', 'solteiro', 'm', 0, '13/12/1987'),
(60, 'Fernando Barbosa', '784.541.132-50', '2354415785', 'solteiro', 'm', 0, '2007-05-04');
...
--
ALTER TABLE `boletim`
  MODIFY `ID_BOLETIM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `exame`
  MODIFY `ID_EXAME` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `funcionario`
--
ALTER TABLE `funcionario`
  MODIFY `ID_FUNCIONARIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `pessoa`
  MODIFY `ID_PESSOA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `responsavel`
  MODIFY `ID_RESPONSAVEL` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
