...
$sql = ("SELECT id_tipo_exame, descricao FROM tipo_exame");
...
<body>
    ...
    <div class="modal fade" id="listar_tipos_exames" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
